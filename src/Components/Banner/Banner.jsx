...
const Banner = () => {
  return (
    <div className=" my-20  flex flex-col-reverse  lg:flex-row justify-between gap-10 lg:gap-0" >
     ...
     <a className=" mx-auto lg:mx-0 Btn-Primary mt-10 flex gap-5 items-center justify-center w-40" href="/Hossain-Hasan-Redoy-Resume.pdf" target="_blank" rel="noopener noreferrer" download ><FaDownload></FaDownload> Resume</a>
     </div>
     <div className="mx-auto lg:mx-0 text-end flex-1 flex  justify-end  ">
      <Image className=" border rounded-full border-green-600 p-2  w-64 h-64 lg:w-[300px] lg:h-[310px]  xl:h-[400px] xl:w-[400px] transition-all delay-150"  src={hhrdoy} width={400} height={400} alt="Hossain Hasan Redoy-image"></Image>
     </div>
    </div>
  );
};
