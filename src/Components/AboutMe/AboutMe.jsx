    ...
    <div className=" mt-32  ">
      ...
      <section className="flex gap-5 flex-col lg:flex-row pt-10">
        ...
        <div className=" w-full flex-1 lg:w-[60%] lg:pr-8  ">
          <h4 className=" text-base md:text-lg text-center lg:text-start font-medium">
          ...
          <h4 className="  text-base md:text-lg  text-center lg:text-start mt-3 font-medium">
        ...
        <div className=" ">
          ...
          <div className=" shadow-lg px-2 pb-2">
            <h1 className=" text-2xl font-bold  border-b border-gray-400">
              Education
            </h1>
