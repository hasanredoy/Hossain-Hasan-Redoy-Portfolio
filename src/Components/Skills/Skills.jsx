...
const [skills,setSkills]=useState([]) 
  ...
  return (
    <div className=" mt-32">
      <h1 className=" border-b-2 border-gray-900 mb-10 w-52 mx-auto text-2xl lg:text-3xl font-black text-center shadow-lg shadow-slate-400 pb-1">My Skills</h1>
      ...
      <div className=" grid grid-cols-3 md:grid-cols-6  mt-10 gap-5 lg:gap-10 w-[90%] justify-center items-center text-center lg:w-[80%] mx-auto">{isSkillsLoading||skills?.map(skill=><div className=" rounded-lg mx-auto  " key={skill._id}>
