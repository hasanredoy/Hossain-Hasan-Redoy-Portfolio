...
const Skills = () => {
  ...
  return (
    <div className=" my-40">
      <h1 className=" text-4xl text-center border-b-2 border-gray-400 shadow-lg shadow-gray-400 font-black w-60 mx-auto">My Skills</h1>
      ...
      <div className=" grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 mt-10 gap-10 w-[80%] lg:w-[60%] mx-auto">{
       isFetching||skills?.map(skill=><div className=" animateDiv z-10" data-title={skill?.title} key={skill._id}>
